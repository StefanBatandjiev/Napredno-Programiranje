...
//
//        public Contact(String name, String[] phonenumber) throws InvalidNameException {
//            String [] firstThreeNumbers = {"070","071","072","075","076","078"};
//            int flag = 0,MAX = 0,k = 0;
//            if(name.length()<4 || name.length()>10 || !name.matches("[a-zA-Z]+"))
...
//                if (MAX < 5) {
//                    for (String firstThreeNumber : firstThreeNumbers) {
//                        if (s.startsWith(firstThreeNumber)) {
//                            this.phonenumber[k++] = s;
//                            flag = 1;
//                            MAX++;
//                        }
//                    }
//                    if (flag == 0) throw new InvalidNumberException();
//                    else flag = 0;
...
//            if(this.phonenumber.length>4)throw new MaximumSizeExceddedException();
//            else {
//
//            }
//        }
