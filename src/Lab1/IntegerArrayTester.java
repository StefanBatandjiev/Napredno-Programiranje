...
public class IntegerArrayTester {
    ...
    public static void main(String[] args) throws IOException {
        ...
        switch (s) {
            ...
            case "testImmutability":
                ...
                IntegerArray integerArray = new IntegerArray(a);
                testSimpleMethods(ia);
                testSimpleMethods(ia);
    ...
    static final class IntegerArray {
        ...
        public IntegerArray(int [] a,boolean copy){
            if(copy){
                this.a = a;
            }
            else this.a = Arrays.copyOf(a,a.length);
        }
        ...
        public IntegerArray concat(IntegerArray ia) {
            int[] array = Arrays.copyOf(this.a, this.length() + ia.length());
